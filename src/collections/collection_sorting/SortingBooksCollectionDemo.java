package src.collections.collection_sorting;
...
class Book implements Comparable<Book> {
    ...
    public int compareTo(Book b) {
        if (this.id > b.id) { // ascending order
            return 1;
...
public class SortingBooksCollectionDemo {
    public static void main(String[] args) {
        ...
        Collections.sort(bookList,
                (Comparator<Book>) (book1, book2) -> book1.name.compareTo(book2.name)); // using lambda expression
